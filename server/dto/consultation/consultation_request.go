...
type CreateConsultationRequest struct {
	...
	Age        int    `json:"age,string,omitempty" gorm:"type: int" validate:"required"`
	Height     int    `json:"height,string,omitempty" gorm:"type: int" validate:"required"`
	Weight     int    `json:"weight,string,omitempty" gorm:"type: int" validate:"required"`
	...
	LiveConsul string `json:"liveConsul" validate:"required"`
